...
@interface LBShoppingCarViewController ()<UITableViewDelegate,UITableViewDataSource,UICollectionViewDelegate,UICollectionViewDataSource>
{
    LBCarListModel *modelList;
    LBGoodsDetailModel *DetailModel;
...
@property(strong,nonatomic)UICollectionView *guessCollectionView;
@end

@implementation LBShoppingCarViewController
@synthesize isPushIn;
@synthesize guessCollectionView;
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (void)loadBottom
{
    ...
    //添加小结文本框
    UILabel *lab2 = [[UILabel alloc]initWithFrame:CGRectMake(lab.frame.origin.x+lab.frame.size.width+5,5, 40, 30)];
...
-(void)drawCollectionView
{
    ...
    guessCollectionView=[[UICollectionView alloc]initWithFrame:CGRectMake(0, 0,SCREEN_WIDTH,SCREEN_HEIGHT)collectionViewLayout:layout];
    [layout setScrollDirection:UICollectionViewScrollDirectionVertical];
    
    guessCollectionView.backgroundColor = [UIColor whiteColor];
    guessCollectionView.delegate = self;
    guessCollectionView.dataSource = self;
    guessCollectionView.scrollEnabled  = YES;
    guessCollectionView.backgroundColor=[UIColor redColor];
    [guessCollectionView registerClass:[UICollectionViewCell class]forCellWithReuseIdentifier:collectionView_cid];
   __tableView.tableFooterView=guessCollectionView;
...
//    [cell addSubview:_towSelectBtn];
    ...
    [cell._shanchuButton setTag:[modelList.cart_id integerValue]];
    [cell._shanchuButton addTarget:self action:@selector(clickDelete:) forControlEvents:UIControlEventTouchUpInside];
    return cell;
}
-(void)clickDelete:(UIButton *)btn
{
    ...
    [self editCar:row1 quantity:nil URL:SUGE_CAR_DEL];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   UILabel *goodsLabel =  [[UILabel alloc] initWithFrame:CGRectMake(goodsImageView.frame.origin.x,goodsImageView.frame.origin.y+goodsImageView.frame.size.height+5,goodsImageView.frame.size.width,30)];
    ...
    [cell.contentView addSubview:goodsLabel];
    
    UILabel *goodspriceLabel =  [[UILabel alloc] initWithFrame:CGRectMake(goodsLabel.frame.origin.x,goodsLabel.frame.origin.y+goodsLabel.frame.size.height+5,goodsLabel.frame.size.width,30)];
