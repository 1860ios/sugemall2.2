...
//    [self.contentView addSubview:_isSelectImg];
    ...
    //删除
    __shanchuButton=[UIButton buttonWithType:UIButtonTypeCustom];
    __shanchuButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH-40,__addBtn.frame.origin.y, 30, 30)];
    [__shanchuButton setImage:IMAGE(@"delete") forState:0];
    [self.contentView addSubview:__shanchuButton];
}
