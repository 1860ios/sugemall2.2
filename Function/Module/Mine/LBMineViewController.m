...
- (void)loadIconsDatas
{
    ...
    [maneger POST:SUGE_MY_SUGE parameters:parameter success:^(AFHTTPRequestOperation *op,id responObject){
        ...
        }else  if ([vip_consume isEqualToString:@"1000"]) {
...
{
    headerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, 245)];
    ...
    UIView *lineView1=[[UIView alloc]initWithFrame:CGRectMake(0,View1.frame.origin.y+View1.frame.size.height+30, SCREEN_WIDTH, 10)];
    lineView1.backgroundColor= [UIColor colorWithWhite:0.93 alpha:0.97];
    // view1.backgroundColor=[UIColor redColor];
    [headerView addSubview:lineView1];
    
    caifuImageView=[[UIImageView alloc]initWithFrame:CGRectMake(20,lineView1.frame.origin.y+lineView1.frame.size.height+10,30, 30)];
    ...
    jiantouImageView=[[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-30, caifuLabel.frame.origin.y+4, 20, 20)];
    ...
    UIView *view1=[[UIView alloc]initWithFrame:CGRectMake(0,caifuLabel.frame.origin.y+caifuLabel.frame.size.height+10, SCREEN_WIDTH, 10)];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    serviceButton2.frame = CGRectMake(serviceButton1.frame.origin.x+serviceButton1.frame.size.width+67,serviceButton1.frame.origin.y,serviceButton1.frame.size.width,serviceButton1.frame.size.height);
    ...
    serviceButton3.frame = CGRectMake(serviceButton2.frame.origin.x+serviceButton2.frame.size.width+67,serviceButton2.frame.origin.y,serviceButton2.frame.size.width,serviceButton2.frame.size.height);
    ...
    UIView *lineView5=[[UIView alloc]initWithFrame:CGRectMake(serviceButton2.frame.origin.x+serviceButton2.frame.size.width+30,serviceButton2.frame.origin.y+10, 1, 30)];
    lineView5.backgroundColor=[UIColor colorWithWhite:0.93 alpha:0.97];
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSArray *array=@[@"个人中心修改_19",@"个人中心修改_21",@"个人中心修改_21-21",@"redbag",@"个人中心修改_22-35",@"个人中心修改_32-36",@"suge_bank_1"];
    NSArray *array1=@[@"通讯录",@"我的名片",@"实名认证",@"红包",@"安全设置",@"收货地址",@"银行卡"];
    
    UIImageView *cardImageView=[[UIImageView alloc]initWithFrame:CGRectMake(10, 40, SCREEN_WIDTH/4-30-28, SCREEN_WIDTH/4-30-28)];
        ...
        case 2:
            if (isLogin) {
                if ([cardId intValue]==0) {
                    ...
                    end.hidesBottomBarWhenPushed = YES;
...
- (void)loadRealDatas
{
    ...
    [manager POST:SUGE_REALNAME parameters:parameter success:^(AFHTTPRequestOperation *operation, id responseObject) {
        NSLog(@"实名认证%@",responseObject);
        cardId=responseObject[@"datas"][@"id"];
        name=responseObject[@"datas"][@"member_truename"];
        card=responseObject[@"datas"][@"member_idcard"];
    } failure:^(AFHTTPRequestOperation *operation, NSError *error) {
