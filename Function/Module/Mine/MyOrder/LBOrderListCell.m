...
//    __goods_price_label.font = [UIFont boldSystemFontOfSize:15];
    ...
    _lineView2=[[UIView alloc]initWithFrame:CGRectMake(lineView.frame.origin.x,__order_amount_label.frame.origin.y+__order_amount_label.frame.size.height+10, SCREEN_WIDTH-10, 1)];
    _lineView2.backgroundColor=[UIColor colorWithWhite:0.93 alpha:0.93];
    [view addSubview:_lineView2];
    
    //b1
    __orderCancel.frame = CGRectMake(SCREEN_WIDTH - 120-25, _lineView2.frame.origin.y+_lineView2.frame.size.height+5, 60, 25);
    //b2
    ...
    //b3
    __searchDeliver.frame = CGRectMake(SCREEN_WIDTH-60-10-10-60, _lineView2.frame.origin.y+_lineView2.frame.size.height+5, 60, 25);
}
