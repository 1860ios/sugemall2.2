...
-(void)loadQRCodeImage
{
    ...
    NSArray *orderTitles1 = @[@"photo",@"firend",@"weixin"];

    for (int i = 0; i<3; i++) {
        
       UIButton *button1 = [UIButton buttonWithType:UIButtonTypeCustom];
        button1.frame =CGRectMake(EACH_W(3 * i)+40, view1.frame.origin.y+view1.frame.size.height+20, 60, 60);
        ...
        orderTitlesLabel.frame = CGRectMake(button1.center.x-53, button1.frame.origin.y+button1.frame.size.height+10, 110, 15);
