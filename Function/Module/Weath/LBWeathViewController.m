...
-(void)initTopView
{
    ...
    [jiantouButton setImage:IMAGE(@"whitejiantou") forState:0];
    [incomeView addSubview:jiantouButton];
    
    UIButton *billButton=[UIButton buttonWithType:UIButtonTypeCustom];
    billButton.frame=CGRectMake(jiantouButton.frame.origin.x-40, jiantouButton.frame.origin.y, 40, 20);
...
-(UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UILabel *nameLabel=[[UILabel alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH/3-35, 30)];
    nameLabel.font=FONT(14);
    UIView *lineView=[[UIView alloc]initWithFrame:CGRectMake(nameLabel.frame.origin.x+nameLabel.frame.size.width+20,0, 2, 50)];
    ...
    numLabel2=[[UILabel alloc]initWithFrame:CGRectMake(0, nameLabel.frame.origin.y+nameLabel.frame.size.height, nameLabel.frame.size.width, 35)];
    ...
    UIView *longLineView=[[UIView alloc]initWithFrame:CGRectMake(0,numLabel2.frame.origin.y+numLabel2.frame.size.height+15,SCREEN_WIDTH, 2)];
