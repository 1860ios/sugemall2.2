...
- (void)initGoodsCell
{
    ...
    UITapGestureRecognizer *tap=[[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(clickDial)];
    ...
    zixunLabel.userInteractionEnabled=YES;
    [zixunLabel addGestureRecognizer:tap];
