...
//        step2.price = allNum;
        ...
        orderId = responObject[@"datas"][@"pay_sn"];
        body = goodsList.goods_name;
        subject = goodsList.goods_name;
        price = allNum;
...
-(void)payBag
{
    ...
    if (signedString != nil) {
        ...
        [[AlipaySDK defaultService] payOrder:orderString fromScheme:appScheme callback:^(NSDictionary *resultDic) {
            ...
            [[[UIAlertView alloc]initWithTitle:@"提示" message:erreo delegate:self cancelButtonTitle:@"" otherButtonTitles: nil] show];
            [self.navigationController popViewControllerAnimated:YES];
        }];
...
-(void)weiXin
{
    ...
    NSMutableDictionary *dict = [req sendPay_demo_pysn:orderId price:price body:body];
...
//            return freightCell;
            NSArray *array=@[@"余额支付",@"他人支付",@"支付宝支付",@"微信支付"];
